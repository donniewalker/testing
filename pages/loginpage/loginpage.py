...
class LoginPage(SeleniumDriver):
    ...
    def is_valid(self):
        self.wait_for_element(self._profile_locator, self._profile_locator_type, pollFrequency=1)
    ...
    def invalid_login_page(self, username, password):
        ...
        self.wait_for_element(self._logout_locator, self._logout_locator_type, pollFrequency=1)
        self.click_element(self._logout_locator, self._logout_locator_type)
        self.wait_for_element(self._username_locator, self._username_locator_type, pollFrequency=1)
        self.clear_fields()
        self.enter_username(username)
        self.enter_password(password)
        self.click_login_button()
